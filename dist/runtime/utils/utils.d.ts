export declare const setCookieTokenAndRefreshToken: (event: any, config: any, tokenSet: any) => void;
export declare const setCookieInfo: (event: any, config: any, userinfo: any) => Promise<void>;
